...
function CampaignsContent() {
  ...
  const { data: campaigns, isLoading: listLoading, refetch: refetchList } = useQuery({
    queryKey: ["campaigns"],
      ...
      return (
        <div className="flex min-h-[60vh] items-center justify-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-zinc-500 font-medium">Loading campaign analytics...</p>
          </div>
        </div>
      );
    }
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-6">
          <Card className="border-zinc-100 bg-white dark:border-zinc-900 dark:bg-zinc-950">
            <CardContent className="pt-6 flex flex-col gap-1">
              ...
              <p className="text-[10px] text-zinc-400 font-medium">100% of audience</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-100 bg-white dark:border-zinc-900 dark:bg-zinc-950">
            <CardContent className="pt-6 flex flex-col gap-1">
              <div className="flex justify-between items-center text-zinc-400">
                <span className="text-xs font-semibold uppercase tracking-wider">Opened</span>
          ...
          <Card className="border-zinc-100 bg-white dark:border-zinc-900 dark:bg-zinc-950">
            <CardContent className="pt-6 flex flex-col gap-1">
              <div className="flex justify-between items-center text-zinc-400">
                <span className="text-xs font-semibold uppercase tracking-wider">Clicked</span>
          ...
          <Card className="border-zinc-100 bg-white dark:border-zinc-900 dark:bg-zinc-950">
            <CardContent className="pt-6 flex flex-col gap-1">
              <div className="flex justify-between items-center text-zinc-400">
                <span className="text-xs font-semibold uppercase tracking-wider">Purchased</span>
              ...
              {campaign.insight ? (
                <>
                  <div className="flex flex-col gap-1">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-zinc-400">Performance Summary</h4>
                  ...
                  <div className="flex flex-col gap-1 border-t border-zinc-100 pt-3 dark:border-zinc-900">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-zinc-400">Recommendations & Follow-up</h4>
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link 
          href="/ai-copilot"
          className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90 transition-opacity"
        >
      ...
      {listLoading ? (
          ...
          <CardContent className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 max-w-sm mt-1">
                You haven't launched any marketing campaigns yet. Let's create your first segment in AI Copilot!
              </p>
            </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {campaigns.map((c) => (
            <Card key={c.id} className="border border-zinc-100 bg-white/50 backdrop-blur-md transition-all hover:shadow-md dark:border-zinc-900 dark:bg-zinc-950/50 flex flex-col justify-between">
